...
- **Галерея и смену плащей** — выбор плащей из встроенной галереи (Minecon 2011–2016, 15th Anniversary, Cherry Blossom, Vanilla, Migrator, TikTok, Twitch, OptiFine), управление официальными плащами Mojang и загрузка своих кастомных текстур.

### 📦 Каталог модов и сборок (Modrinth & CurseForge)
...
- **Готовые модпаки** — поиск и установка сборок с Modrinth и CurseForge, импорт `.mrpack` и `.zip` перетаскиванием (drag & drop) или через диалог.
