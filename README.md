...
- **Смена версий и лоадеров** — быстрое переключение версии Minecraft (релизы, снапшоты) и модлоадеров (**Vanilla**, **Fabric**, **Forge**, **NeoForge**) прямо из настроек сборки.
...
Для разработки требуются [Go 1.25+](https://go.dev), [Node.js](https://nodejs.org) и [Wails v3 CLI](https://v3.wails.io/):
...
wails3 build
```
Скомпилированный файл будет находиться в директории `bin/WaiLauncher.exe`.
...
Собрано с ❤️ на Go + Vue 3 + Wails v3.
