    ...
    <div class="modal-box about-modal-box">
      <div class="modal-body about-modal-body">
        <div class="about-hero">
          ...
          <p class="about-app-version">v{{ store.launcherVer || '1.1.3' }} &mdash; {{ t('about.desc') || 'Современный лаунчер Minecraft нового поколения' }}</p>
        </div>
        ...
        <div class="about-card-section">
          ...
          <div class="about-links-col">
            <div class="about-link-row" @click="openExternal('https://github.com/PerfLite/WaiLauncher')">
              ...
              <div class="about-link-label-group">
                <span class="about-link-label">GitHub: <strong class="about-highlight">PerfLite / WaiLauncher</strong></span>
                <span class="about-link-sub">github.com/PerfLite/WaiLauncher</span>
              </div>
            </div>
            <div class="about-link-row" @click="openExternal('https://t.me/bashakul')">
              ...
              <div class="about-link-label-group">
                ...
                <span class="about-link-sub">t.me/bashakul</span>
              </div>
            </div>
        ...
        <div class="about-card-section">
          ...
          <div class="about-tags-row">
            <span class="about-tag tag-go">Go 1.26+</span>
            <span class="about-tag tag-wails">Wails v3</span>
            <span class="about-tag tag-vue">Vue 3</span>
            <span class="about-tag tag-vite">Vite 7</span>
            <span class="about-tag tag-tailwind">Tailwind CSS</span>
